...
#define EXAMPLE_ESP_WIFI_PASS "YOUR WIFI PWD"
...
void wifi_init_sta(void)
{
    ...
    wifi_config_t wifi_config = {
        .sta = {
             ...
             */
            .threshold.authmode = CONFIG_ESP_WIFI_AUTH_WPA_WPA2_PSK,
            // .sae_pwe_h2e = ESP_WIFI_SAE_MODE,
            // .sae_h2e_identifier = EXAMPLE_H2E_IDENTIFIER,
			.scan_method = WIFI_ALL_CHANNEL_SCAN,  // nécessaire pour réseau caché
