 ...
 * Constants
 * -------------------------------------------------------------------------- */
#define PATH_SIZE         10   /* Deep max for Path     10              */
#define USAGE_TAB_SIZE    50   /* Size of usage stack   50              */
#define MAX_REPORT        500  /* Including FEATURE, INPUT and OUTPUT 500*/
#define REPORT_DSC_SIZE   6144 /* Size max of Report Descriptor  6144     */
