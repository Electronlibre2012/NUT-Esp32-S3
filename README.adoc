...
6-Clean : idf.py fullclean

7-Build : idf.py build

8-Flash : idf.py -p COM8 flash monitor (COM PORT adapt to your USB port)

9-Check the logs and you can see the wifi connection and com ok with green and blue led

10-Go to HA, dowload NUT integration https://www.home-assistant.io/integrations/nut
11-Add your UPS with IP adress (static is a must ) and port : standard is 3493
12-Nice, you have your UPS in HA! ENJOY
